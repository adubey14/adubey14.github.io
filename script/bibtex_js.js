...
function bibtex_js_draw() {
  ...
  $.get("../resumebookchapter.bib", function(data){(new BibtexDisplay()).displayBibtex(data, $("#book_chapter"));}, 'text');
  $.get("../resumejournal.bib", function(data){(new BibtexDisplay()).displayBibtex(data, $("#journal"));}, 'text');
}
